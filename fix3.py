...
const applyTheme = (theme: Theme) => {
  ...
  root.style.background =  + "'linear-gradient(135deg, '" + " + ''" + " + ') 0%, '" + " + ''" + " + ') 50%, '" + " + ''" + " + ') 100%)'" + ";
};
